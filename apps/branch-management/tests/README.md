...
```sh
yarn devo branch-management test:unit
```
...
```sh
yarn devo branch-management test:integration --runInBand
```
...
```sh
yarn devo branch-management test:benchmark
```
...
```sh
yarn devo branch-management yarn test:e2e
```
...
```sh
yarn devo branch-management test:unit -t name-of-test
```
...
```sh
yarn devo branch-management test:watch
```
...
```sh
yarn devo branch-management test:coverage
```
