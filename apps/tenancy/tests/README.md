...
```sh
yarn devo tenancy test:integration --runInBand
```
...
```sh
yarn devo tenancy test:benchmark
```
...
```sh
yarn devo tenancy test:unit -t name-of-test
```
...
```sh
yarn devo tenancy test:coverage
```
