...
# Multiple Organization Architecture (Multi-tenancy)

This project provides single-domain, multi-tenant capability for SaaS applications.
...
This command will run the necessary infrastructure services for the tenancy:

```sh
yarn devo start -s tenancy --verbose
```
