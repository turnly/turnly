...
import { AnswersFactory } from '../../../../../src/Answers/infrastructure/factories/AnswersFactory'
import { AnswerMother } from '../../../../unit/Answers/domain/AnswerMother'
import { AnswersQueryMother } from './AnswersQueryMother'

const writableRepo = AnswersFactory.getWritableRepo()
const readableRepo = AnswersFactory.getReadableRepo()
