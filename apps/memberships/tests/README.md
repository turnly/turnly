...
```sh
yarn devo memberships test:unit
```
...
```sh
yarn devo memberships test:integration --runInBand
```
...
```sh
yarn devo memberships test:benchmark
```
...
```sh
yarn devo memberships test:e2e
```
...
```sh
yarn devo memberships test:unit -t name-of-test
```
...
```sh
yarn devo memberships test:watch
```
...
```sh
yarn devo memberships test:coverage
```
