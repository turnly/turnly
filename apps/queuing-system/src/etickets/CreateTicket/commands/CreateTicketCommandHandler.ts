...
import { ActiveTicketsByCustomerQuery } from 'etickets/eshared/application/queries/ActiveTicketsByCustomerQuery/active-tickets-by-customer.query'
...
import { TicketPriority } from 'etickets/eshared/domain/enums/TicketPriority'
import { TicketStatus } from 'etickets/eshared/domain/enums/TicketStatus'
