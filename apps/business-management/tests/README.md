...
# Business Management Test Suites
...
```sh
yarn devo business-management test:unit
```
...
```sh
yarn devo business-management test:integration --runInBand
```
...
```sh
yarn devo business-management test:benchmark
```
...
```sh
yarn devo business-management test:e2e
```
...
```sh
yarn devo business-management test:unit -t name-of-test
```
...
```sh
yarn devo business-management test:watch
```
...
```sh
yarn devo business-management test:coverage
```
