...
import { AgentsFactory } from '../../../../../src/Agents/infrastructure/factories/AgentsFactory'
import { AgentMother } from '../../../../unit/Agents/domain/AgentMother'
import { AgentsQueryMother } from './AgentsQueryMother'

const writableRepo = AgentsFactory.getWritableRepo()
const readableRepo = AgentsFactory.getReadableRepo()
