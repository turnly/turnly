...
export type AnnounceTicketMutation = {
  __typename?: 'Mutation'
  announceTicket: {
    __typename?: 'TicketModel'
    id: string
...
export type LeaveTicketMutation = {
  __typename?: 'Mutation'
  leaveTicket: {
    __typename?: 'TicketModel'
    id: string
...
export type TakeTicketMutation = {
  __typename?: 'Mutation'
  takeTicket: {
    __typename?: 'TicketModel'
    id: string
...
export type GetServiceFieldsQuery = {
  __typename?: 'Query'
  getServiceFields: Array<{
    __typename?: 'FieldModel'
    id: string
    label: string
    description?: string | null
    ...
    extra: Array<{ __typename?: 'ExtraModel'; key: string; value: string }>
  }>
}
...
`
export type AnnounceTicketMutationFn = Apollo.MutationFunction<
  AnnounceTicketMutation,
  AnnounceTicketMutationVariables
>
 ...
 * });
 */
export function useAnnounceTicketMutation(
  ...
  return Apollo.useMutation<
    AnnounceTicketMutation,
    AnnounceTicketMutationVariables
  >(AnnounceTicketDocument, options)
}
export type AnnounceTicketMutationHookResult = ReturnType<
  typeof useAnnounceTicketMutation
>
export type AnnounceTicketMutationResult =
  Apollo.MutationResult<AnnounceTicketMutation>
export type AnnounceTicketMutationOptions = Apollo.BaseMutationOptions<
  AnnounceTicketMutation,
  AnnounceTicketMutationVariables
>
...
`
export type LeaveTicketMutationFn = Apollo.MutationFunction<
  LeaveTicketMutation,
  LeaveTicketMutationVariables
>
 ...
 * });
 */
export function useLeaveTicketMutation(
  baseOptions?: Apollo.MutationHookOptions<
    LeaveTicketMutation,
    LeaveTicketMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<LeaveTicketMutation, LeaveTicketMutationVariables>(
    LeaveTicketDocument,
    options
  )
}
export type LeaveTicketMutationHookResult = ReturnType<
  typeof useLeaveTicketMutation
>
export type LeaveTicketMutationResult =
  Apollo.MutationResult<LeaveTicketMutation>
export type LeaveTicketMutationOptions = Apollo.BaseMutationOptions<
  LeaveTicketMutation,
  LeaveTicketMutationVariables
>
...
`
export type TakeTicketMutationFn = Apollo.MutationFunction<
  TakeTicketMutation,
  TakeTicketMutationVariables
>
...
export function useTakeTicketMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useMutation<TakeTicketMutation, TakeTicketMutationVariables>(
    TakeTicketDocument,
    options
  )
}
export type TakeTicketMutationHookResult = ReturnType<
  typeof useTakeTicketMutation
>
export type TakeTicketMutationResult = Apollo.MutationResult<TakeTicketMutation>
export type TakeTicketMutationOptions = Apollo.BaseMutationOptions<
  TakeTicketMutation,
  TakeTicketMutationVariables
>
 ...
 * });
 */
export function useGetServiceFieldsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetServiceFieldsQuery,
    GetServiceFieldsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<GetServiceFieldsQuery, GetServiceFieldsQueryVariables>(
    GetServiceFieldsDocument,
    options
  )
}
export function useGetServiceFieldsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetServiceFieldsQuery,
    GetServiceFieldsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetServiceFieldsQuery,
    GetServiceFieldsQueryVariables
  >(GetServiceFieldsDocument, options)
}
export type GetServiceFieldsQueryHookResult = ReturnType<
  typeof useGetServiceFieldsQuery
>
export type GetServiceFieldsLazyQueryHookResult = ReturnType<
  typeof useGetServiceFieldsLazyQuery
>
export type GetServiceFieldsQueryResult = Apollo.QueryResult<
  GetServiceFieldsQuery,
  GetServiceFieldsQueryVariables
>
