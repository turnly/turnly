...
const ticks = [{
        id: 'ticket_RscKZ-Nrzy7mk0GjOhuxJ',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-343',
        serviceId: 'srv_YKLAAgZaysHLsKBmphIwO',
        locationId: 'loc_xdeJQM9lFV5GdofxAAMYI',
        customerId: 'cust_TClBaYqWnrlPtNs3cOpxF',
        organizationId: 'org_zyUlCzVfPD6pKQfI_OdkN',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_6-7yjFeOZ-lNIQHiaigiN',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-444',
        serviceId: 'srv_1-ZZpLH4UaGjB1viTehGE',
        locationId: 'loc_xdeJQM9lFV5GdofxAAMYI',
        customerId: 'cust_LfcNUKK6X_zhIxqDO3Sxz',
        organizationId: 'org_zyUlCzVfPD6pKQfI_OdkN',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_JWsH6AX1THa7kugix4qfg',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-443',
        serviceId: 'srv_1-ZZpLH4UaGjB1viTehGE',
        locationId: 'loc_xdeJQM9lFV5GdofxAAMYI',
        customerId: 'cust_NDp4yydxeXwRoWcDpgGiV',
        organizationId: 'org_zyUlCzVfPD6pKQfI_OdkN',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_gRQTkVyW3Of1Oh1PieI9a',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-566',
        serviceId: 'srv_YKLAAgZaysHLsKBmphIwO',
        locationId: 'loc_xdeJQM9lFV5GdofxAAMYI',
        customerId: 'cust_48nYKMXoGD_Z8waFZXEMv',
        organizationId: 'org_zyUlCzVfPD6pKQfI_OdkN',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_JP3oNmlyCcD5LCYFBA90M',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-713',
        serviceId: 'srv_YKLAAgZaysHLsKBmphIwO',
        locationId: 'loc_xdeJQM9lFV5GdofxAAMYI',
        customerId: 'cust_W6eULbvcWFTsrEYDdRoMP',
        organizationId: 'org_zyUlCzVfPD6pKQfI_OdkN',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_ckAIMXY7nD1yqvWLIcG2v',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-754',
        serviceId: 'test_srv_hhXF2ASb1Ro0CiggTcEsd',
        locationId: 'test_loc_5EJBm6M_59hiVWf11DyJ8',
        customerId: 'cust_F5QbHv-41YunvlWkF5w70',
        organizationId: 'org_VTTHK6J7ZLgtWiL-FLLWb',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_znwSW1NUH6J8aepvumhJD',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-125',
        serviceId: 'test_srv_vIVQUHcS4mztwIoBMNZQ7',
        locationId: 'test_loc__rVmf2v1BFSCjWpNuf0-I',
        customerId: 'cust_R2c-gQfOXP4LhPZ3kqy0x',
        organizationId: 'org_VTTHK6J7ZLgtWiL-FLLWb',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_IAX4FAcro3Kx2lPPoJ5GQ',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-538',
        serviceId: 'test_srv_rVY1n7BXkWw2wNfWHKONa',
        locationId: 'test_loc_yeqSx9E2Any3YogAvoPwZ',
        customerId: 'cust_Hj4yBjoJhrAmGsOb69krO',
        organizationId: 'org_VTTHK6J7ZLgtWiL-FLLWb',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_jOLv3jXf-3TnjLaUlxjbZ',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-512',
        serviceId: 'test_srv_PussPPM1XKcIzmDPmK9Zr',
        locationId: 'test_loc_1LUrEjklryPBfYBIFjLX1',
        customerId: 'cust_TTzKR2qAR_XNEC-29oBc-',
        organizationId: 'org_VTTHK6J7ZLgtWiL-FLLWb',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
      ...
      {
        id: 'ticket_HQYnknYf-9s1QeYEgA3E_',
        status: 'booked',
        priority: 'normal',
        displayCode: 'TEST-756',
        serviceId: 'test_srv_uXug9aFWQYQxSgTEJZyFi',
        locationId: 'test_loc_bbeRh43VlekyuV6Kpmxha',
        customerId: 'cust_AqWPfoERAt6j4G-P5nbaa',
        organizationId: 'org_VTTHK6J7ZLgtWiL-FLLWb',
        extra: [],
        createdAt: undefined,
        updatedAt: null,
