...
This module contains the common parts between all services in general terms,
whether it is RESTfull, RPC or WebSocket, you will find highly valuable and commonly used libraries.

### Installation

```sh
yarn add @turnly/common
```
