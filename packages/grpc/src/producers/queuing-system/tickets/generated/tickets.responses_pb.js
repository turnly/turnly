...
goog.exportSymbol('proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse', null, global);
 ...
 * @constructor
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.repeatedFields_, null);
};
goog.inherits(proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.displayName = 'proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    dataList: jspb.Message.toObjectList(msg.getDataList(),
    proto.turnly.queuing_system.v1.tickets.Ticket.toObject, includeInstance),
    meta: (f = msg.getMeta()) && common_pb.Meta.toObject(includeInstance, f)
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse;
  return proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDataList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.turnly.queuing_system.v1.tickets.Ticket>}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.getDataList = function() {
  return /** @type{!Array<!proto.turnly.queuing_system.v1.tickets.Ticket>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.turnly.queuing_system.v1.tickets.Ticket, 1));
};
...
/**
 * @param {!Array<!proto.turnly.queuing_system.v1.tickets.Ticket>} value
 * @return {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} returns this
*/
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.setDataList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.turnly.queuing_system.v1.tickets.Ticket}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.addData = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.turnly.queuing_system.v1.tickets.Ticket, opt_index);
};
 ...
 * @return {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} returns this
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.clearDataList = function() {
  return this.setDataList([]);
};
 ...
 * @return {?proto.turnly.common.v1.Meta}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.getMeta = function() {
  return /** @type{?proto.turnly.common.v1.Meta} */ (
    jspb.Message.getWrapperField(this, common_pb.Meta, 2));
};
 ...
 * @return {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} returns this
*/
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.setMeta = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse} returns this
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.clearMeta = function() {
  return this.setMeta(undefined);
};
 ...
 * @return {boolean}
 */
proto.turnly.queuing_system.v1.tickets.ListTicketsForSignageDisplaysResponse.prototype.hasMeta = function() {
  return jspb.Message.getField(this, 2) != null;
};
